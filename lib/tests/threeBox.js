var ThreeBox = function ThreeBox(container, stats) {
	...
	function addSphereBody(sphere, radius) {
		...
		b2body.userData = {element: sphere};
	
		b2body.position.Set( sphere.position.x, sphere.position.y );
	...
	function initSpheres() {
		...
		for(var i = 0; i < 10; i++) {
			...
			sphere.position.y = Math.random() * 300;
			sphere.position.z = 0;
